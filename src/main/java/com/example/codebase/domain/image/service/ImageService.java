...
public class ImageService {
    ...
    public void mediasUpload(ArtworkCreateDTO dto, List<MultipartFile> mediaFiles) throws IOException {
    ...
    public void thumbnailUpload(ArtworkMediaCreateDTO thumbnailDto, MultipartFile thumbnailFile) throws IOException {
    ...
    public void thumbnailUpload(PostMediaCreateDTO thumbnailDto, MultipartFile thumbnailFile) throws IOException {
        String mediaType = thumbnailDto.getMediaType();
