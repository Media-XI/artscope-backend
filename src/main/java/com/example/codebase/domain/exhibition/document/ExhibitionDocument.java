...
public class ExhibitionDocument {
    ...
    @Builder
    public ExhibitionDocument(Long id, String title, String description, String name, String companyName, String companyRole, String mediaUrl, LocalDateTime createdTime, LocalDateTime updatedTime) {
        this.id = id;
        this.title = title;
