...
public class FileUtil {
    ...
    private static List<String> allowedVideoTypes = List.of("video/mp4", "video/mov", "video/avi", "video/quicktime",
            "video/webm", "video/x-msvideo", "video/x-ms-wmv");
    private static List<String> allowedAudioTypes = List.of("audio/mp3", "audio/wav", "audio/ogg", "audio/mpeg",
